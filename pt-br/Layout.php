                    ...
                    <div class='container'>
                        ...
                        <div class='collapse navbar-collapse' id='navcol-1'>
                            <ul class='nav navbar-nav ml-auto''
                                <li role='presentation' class='nav-item'><a href='about-me.php' class='nav-link'>Sobre Mim</a></li>
                                <li role='presentation' class='nav-item'><a href='curriculo.php' class='nav-link'>Currículo</a></li>
                                <li role='presentation' class='nav-item'><a href='projetos.php' class='nav-link'>Portifólio de Projetos</a></li>
                                <li role='presentation' class='nav-item'>
                                    <a style='cursor: pointer' onclick='window.location.href = window.location.href.replace(\"pt-br\", \"en-us\")' class='nav-link'>
                                        <img style='max-width : 20px; height : auto;' src='../assets/img/us.png'/>
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <footer style='margin-top:0px;'>
                <div class='row justify-content-center align-items-center' style='padding:2%;max-height:50%;'>
                    ...
                    <div class='col-sm-4 col-md-4 footer-contacts text-center' style='padding-top:2%;padding-left:10%;'>
                        <a class='btn btn-outline-primary btn-sm' role='button' href='contact.php' style='color:rgb(255,255,255);'>Ou entre em contato por aqui! : )</a>
                    </div>
                    <div class='col-sm-4 col-md-4 text-center footer-about' style='margin-right:auto;margin-bottom:auto;padding-top:5%'>
                        <p class='text-center'>Me visite nas redes sociais.</p>
